...
const MainSection = () => {
  ...
  return (
    <main>
      ...
      >
        <source src={"https://mordovia-russia.ru/video/mordoviya4_mob.mp4"} type="video/mp4" media="(max-width:1024px)" />
        <source src={"https://mordovia-russia.ru/video/mordoviya4.mp4"} type="video/mp4" />
      </video>
      <div className={"about"}>
